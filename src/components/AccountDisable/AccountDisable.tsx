...
import { InstagramIcon, TwitterIcon } from "@/public/icons";
import { BiSolidLockAlt } from "react-icons/bi"

const AccountDiasble = () => {
    return ( 
        <>
      <div className="w-80 bg-white rounded">
        ...
        <div className="px-10 pb-14">
         <button className="w-full h-[40px] rounded bg-white-5 text-white flex justify-center items-center gap-2">
            <span><BiSolidLockAlt color="#fff"  /></span>
            Message
            </button>
            </div>
      </div>
